...
urlpatterns = [
    ...
    path('liste_artistes',liste_artistes,name='liste_artistes'),
    ...
    path('publier_article/', publier_article, name='publier_article'),
    path('publier_oeuvre/',publier_oeuvre,name='publier_oeuvre'),
   ...
   #path('signaler_colloc/', signaler_colloc, name='signaler_colloc'),
    ...
    path('detail_article/<str:id>',detail_article,name='detail_article'),
    path('DetailArtiste/<str:id>',DetailArtiste,name='DetailArtiste'),
    ...
    path('connexion/confirmation/', confirmation, name='confirmation'),
